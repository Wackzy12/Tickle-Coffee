...
class MochaScreen extends StatefulWidget {
  @override
  State<MochaScreen> createState() => _mochaScreenState();
}

class _mochaScreenState extends State<MochaScreen> {
  ...
  Future<void> _checkIfFavorited() async {
    if (currentUser != null) { // Check if user is logged in
      ...
      setState(() {
        isFavorited = favorites.contains('Mocha');
      });
    }
  }
  ...
  void _toggleFavorite() async {
    if (currentUser != null) { // Check if user is logged in
      if (isFavorited) {
        await FavoritesManager().removeFavorite(currentUser!.uid, 'Mocha');
      } else {
        await FavoritesManager().addFavorite(currentUser!.uid, 'Mocha');
      }
      setState(() {
