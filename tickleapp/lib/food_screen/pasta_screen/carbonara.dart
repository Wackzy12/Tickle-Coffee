...
class _carbonaraScreenState extends State<CarbonaraScreen> {
  ...
  void _toggleFavorite() async {
    if (currentUser != null) { // Check if user is logged in
      if (isFavorited) {
        await FavoritesManager().removeFavorite(currentUser!.uid, 'Carbonara');
      } else {
        await FavoritesManager().addFavorite(currentUser!.uid, 'Carbonara');
      }
      setState(() {
