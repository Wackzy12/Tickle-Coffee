...
class MacaroniScreen extends StatefulWidget {
  @override
  State<MacaroniScreen> createState() => _macaroniScreenState();
}
...
class _macaroniScreenState extends State<MacaroniScreen> {
  ...
  void _toggleFavorite() async {
    if (currentUser != null) { // Check if user is logged in
      if (isFavorited) {
        await FavoritesManager().removeFavorite(currentUser!.uid, 'Macaroni and Cheese');
      } else {
        await FavoritesManager().addFavorite(currentUser!.uid, 'Macaroni and Cheese');
      }
      setState(() {
          ...
          Container(
            ...
            decoration: BoxDecoration(
              image: DecorationImage(
                image: AssetImage('assets/macaroni.jpg'),
                fit: BoxFit.cover,
              ),
            ),
          ),
